...
func newStringCondition(name string, key string, values []interface{}, compareFunc func(a, b interface{}) bool) KeyedCondition {
...
func newStringEqualsCondition(key string, values []interface{}) KeyedCondition {
...
func newStringNotEqualsCondition(key string, values []interface{}) KeyedCondition {
...
func newStringEqualsIgnoreCaseCondition(key string, values []interface{}) KeyedCondition {
...
func newStringNotEqualsIgnoreCaseCondition(key string, values []interface{}) KeyedCondition {
...
func newStringLikeCondition(key string, values []interface{}) KeyedCondition {
...
func newStringNotLikeCondition(key string, values []interface{}) KeyedCondition {
...
func (c *StringCondition) Evaluate(ctxValue interface{}, _ types.EvalContextor) bool {
	values := c.GetValues()
