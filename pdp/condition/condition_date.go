...
func newDateCondition(name string, key string, values []interface{}, compareFunc func(a, b interface{}) bool) (types.Condition, error) {
...
func newDateEqualsCondition(key string, values []interface{}) (types.Condition, error) {
...
func newDateNotEqualsCondition(key string, values []interface{}) (types.Condition, error) {
...
func newDateLessThanCondition(key string, values []interface{}) (types.Condition, error) {
...
func newDateLessThanEqualsCondition(key string, values []interface{}) (types.Condition, error) {
...
func newDateGreaterThanCondition(key string, values []interface{}) (types.Condition, error) {
...
func newDateGreaterThanEqualsCondition(key string, values []interface{}) (types.Condition, error) {
